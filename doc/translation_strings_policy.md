...
This document provides guidelines for internationalization of the HOLD Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `hold_en.ts` remains unchanged.
