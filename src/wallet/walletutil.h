...
#ifndef HOLD_WALLET_WALLETUTIL_H
#define HOLD_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! hold from opening the wallet, thinking it was newly created, and
...
#endif // HOLD_WALLET_WALLETUTIL_H
