...
#ifndef HOLD_WALLET_SCRIPTPUBKEYMAN_H
#define HOLD_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The HOLD Core wallet was originally a collection of unrelated private
...
#endif // HOLD_WALLET_SCRIPTPUBKEYMAN_H
