...
#ifndef HOLD_CRYPTO_CHACHA_POLY_AEAD_H
#define HOLD_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@hold.
 *
 ...
 *
 * The chacha20-poly1305@hold combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@hold cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@hold are relatively fast in
...
#endif // HOLD_CRYPTO_CHACHA_POLY_AEAD_H
