...
{
    BOOST_CHECK(TestSplitHost("www.holdcore.org", "www.holdcore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.holdcore.org]", "www.holdcore.org", -1));
    BOOST_CHECK(TestSplitHost("www.holdcore.org:80", "www.holdcore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.holdcore.org]:80", "www.holdcore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:6700", "127.0.0.1", 6700));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:6700", "127.0.0.1", 6700));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:6700", "::ffff:127.0.0.1", 6700));
    BOOST_CHECK(TestSplitHost("[::]:6700", "::", 6700));
    BOOST_CHECK(TestSplitHost("::6700", "::6700", -1));
    BOOST_CHECK(TestSplitHost(":6700", "", 6700));
    BOOST_CHECK(TestSplitHost("[]:6700", "", 6700));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:6700", "127.0.0.1:6700"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:6700", "[::]:6700"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
