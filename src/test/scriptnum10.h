...
#ifndef HOLD_TEST_SCRIPTNUM10_H
#define HOLD_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from HOLD Core 0.10.0, for cross-comparison.
 */
public:
