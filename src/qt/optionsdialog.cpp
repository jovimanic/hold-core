    ...
    mapper(nullptr)
{
    ...
    ui->holdAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->holdAtStartup);
    ...
    ui->holdAtStartup->setToolTip(ui->holdAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->holdAtStartup->setText(ui->holdAtStartup->text().arg(PACKAGE_NAME));

    ui->openHOLDConfButton->setToolTip(ui->openHOLDConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new HOLDUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->holdAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openHOLDConfButton_clicked()
{
