...
//! Entry point for HOLDApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &HOLDApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for HOLDGUI tests.
void AppTests::guiTests(HOLDGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &HOLDGUI::consoleShown, this, &AppTests::consoleTests);
