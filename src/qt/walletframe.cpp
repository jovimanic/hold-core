...
WalletFrame::WalletFrame(const PlatformStyle* _platformStyle, HOLDGUI* _gui)
    : QFrame(_gui),
      gui(_gui),
...
bool WalletFrame::addWallet(WalletModel *walletModel)
{
    ...
    connect(walletView, &WalletView::transactionClicked, gui, &HOLDGUI::gotoHistoryPage);
    connect(walletView, &WalletView::coinsSent, gui, &HOLDGUI::gotoHistoryPage);
    connect(walletView, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        gui->message(title, message, style);
    });
    connect(walletView, &WalletView::encryptionStatusChanged, gui, &HOLDGUI::updateWalletStatus);
    connect(walletView, &WalletView::incomingTransaction, gui, &HOLDGUI::incomingTransaction);
    connect(walletView, &WalletView::hdEnabledStatusChanged, gui, &HOLDGUI::updateWalletStatus);
    connect(gui, &HOLDGUI::setPrivacy, walletView, &WalletView::setPrivacy);
