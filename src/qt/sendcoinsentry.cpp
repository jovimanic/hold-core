    ...
    platformStyle(_platformStyle)
{
    ...
    // normal hold address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying hold address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &HOLDAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
