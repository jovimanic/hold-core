...
#ifndef HOLD_QT_GUIUTIL_H
#define HOLD_QT_GUIUTIL_H
...
/** Utility functions used by the HOLD Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "hold:" URI into recipient object, return true on successful parsing
