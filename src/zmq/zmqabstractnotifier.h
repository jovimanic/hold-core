// Copyright (c) 2015-2018 The HOLD Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef HOLD_ZMQ_ZMQABSTRACTNOTIFIER_H
#define HOLD_ZMQ_ZMQABSTRACTNOTIFIER_H
...
#endif // HOLD_ZMQ_ZMQABSTRACTNOTIFIER_H
