...
static void SetupHOLDTxArgs(ArgsManager &argsman)
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " hold-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  hold-tx [options] <hex-tx> [commands]  Update hex-encoded hold transaction\n" +
            "or:     hold-tx [options] -create [commands]   Create hex-encoded hold transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded hold transaction
