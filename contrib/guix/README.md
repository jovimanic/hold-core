# Bootstrappable HOLD Core Builds

This directory contains the files necessary to perform bootstrappable HOLD
Core builds.
...
- 24GB of free disk space on the partition that the HOLD Core git repository
  resides in
...
For a HOLD Core depends development environment, simply invoke
...
From the top of a clean HOLD Core repository:
...
To use dongcarl's substitute server for HOLD Core builds after having
