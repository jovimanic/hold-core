...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the hold repository."
  exit 1
fi
...
# See https://github.com/hold/hold/issues/16064
...
echo 'When compiling holdd, run `./configure` in the following way:'
echo
