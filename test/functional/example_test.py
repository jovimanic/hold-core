...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the HOLDTestFramework
    pass


class ExampleTest(HOLDTestFramework):
    # Each functional test is a subclass of the HOLDTestFramework class.
    ...
    def custom_method(self):
        ...
        HOLDTestFramework class so other tests can use it."""
