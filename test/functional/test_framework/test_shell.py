...
class TestShell:
    """Wrapper Class for HOLDTestFramework.

    The TestShell class extends the HOLDTestFramework
    ...
    class __TestShell(HOLDTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by HOLDTestFramework child class.
            self.num_nodes = 1
