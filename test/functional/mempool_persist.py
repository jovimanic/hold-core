...
By default, holdd will dump mempool on shutdown and
...
class MempoolPersistTest(HOLDTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent holdd from writing mempool.dat to disk. Verify that `savemempool` fails")
