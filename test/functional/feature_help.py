...
"""Verify that starting hold with -h works as expected."""

from test_framework.test_framework import HOLDTestFramework
from test_framework.util import assert_equal

class HelpTest(HOLDTestFramework):
    ...
    def run_test(self):
        self.log.info("Start hold with -h for help text")
        ...
        self.log.info("Start hold with -version for version information")
        ...
        self.log.info("Start holdd with -fakearg to make sure it does not start")
