...
class P2PPermissionsTests(HOLDTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].holdconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].holdconf, 'w', encoding="utf8") as f:
            f.write(newText)
